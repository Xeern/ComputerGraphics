...
{0.8f, 0.3f, 0.0f}, {0.95f, 0.2f, 0.0f}, {0.4f, 0.4f, 0.4f}, 1.0f };

Planet mercury = { {0.04f, 0.04f, 0.04f}, 1.6f, {0.4f, 0.0f, 0.0f},
{0.45f, 0.4f, 0.4f}, {1.0f, 1.0f, 1.0f}, {0.2f, 0.2f, 0.2f}, 0.2f };

Planet venus = { {0.095f, 0.095f, 0.095f}, 1.17f, {-0.6f, 0.0f, 0.0f},
{0.6f, 0.8f, 0.2f}, {0.8f, 0.6f, 0.2f}, {0.4f, 0.4f, 0.4f}, 0.5f };

Planet earth = { {0.1f, 0.1f, 0.1f}, 1.0f, {0.9f, 0.0f, 0.0f},
{0.9f, 0.9f, 1.0f}, {0.8f, 0.8f, 0.8f}, {0.4f, 0.4f, 0.4f}, 0.65f };

// not really a planet:
Planet moon = { {0.02f, 0.02f, 0.02f}, 2.5f, {0.16f, 0.0f, 0.0f},
{0.9f, 0.9f, 0.9f}, {0.7f, 0.7f, 0.7f}, {0.2f, 0.2f, 0.2f}, 0.2f };
